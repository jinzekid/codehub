...
def main():
    ...
    print('bsf path:{}'.format(bfs_path if bfs_path else 'Not found'))
    ...
    print(bfs_nopath)
    print('bsf path:{}'.format(bfs_nopath[1] if bfs_nopath[0] else 'Not found'))
    print('dfs path:{}'.format(dfs_nopath[1] if dfs_nopath[0] else 'Not found'))
