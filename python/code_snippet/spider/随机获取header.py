...
class HeaderFactory():
    ...
    def header_info():
        ...
        header_default.append(('User-Agent', get_random_user_agent()))
        return header_default



# def get_data(url, header_info=get_header_info(), post_data = None, proxy_addr = None):
...
# data = get_data(url="http://httpbin.org/post", post_data={'name':'lu'})
